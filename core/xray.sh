...
log "Replacing official Xray with MOD v25.10.15.3..."
tmpzip="/tmp/Xray_core_mod.zip"
curl -sL -f "https://github.com/dotywrt/Xray-core-mod/releases/download/v25.10.15.3/Xray-linux-64-v25.10.15.3.zip" -o "$tmpzip"
...
restart_services
echo -e "●━━━━━━━━━━━━━━━━━━━━🜲IMRAN_TECH━━━━━━━━━━━━━━━━━━━━●"
log "XRAY Core Installed Successfully☑️."
echo -e "●━━━━━━━━━━━━━━━━━━━━🜲IMRAN_TECH━━━━━━━━━━━━━━━━━━━━●"
sleep 3
finalize
}
